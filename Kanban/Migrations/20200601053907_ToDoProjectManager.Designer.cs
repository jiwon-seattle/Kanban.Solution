...
namespace Kanban.Migrations
{
    ...
    [Migration("20200601053907_ToDoProjectManager")]
    partial class ToDoProjectManager
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kanban.Models.ToDoList", b =>
                {
                    b.HasOne("Kanban.Models.Manager")
                        .WithMany("ToDoLists")
                        .HasForeignKey("ManagerId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("Kanban.Models.ProjectManager", "ProjectManager")
                        .WithMany()
